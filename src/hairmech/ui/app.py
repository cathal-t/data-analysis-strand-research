                ...
                dbc.CardBody(
                    [
                        ...
                        dcc.Loading(
                            ...
                            children=[
                                dbc.Alert(
                                    id="dim-cleaning-alert", is_open=False, className="mt-3"
                                ),
                                ...
                                html.Div(
                                    [
                                        ...
                                        html.Div(
                                            id="dim-removed-summary-message", className="mt-3"
                                        ),
                                        html.Div(
                                            id="dim-removed-summary-table", className="mt-3"
                                        ),
                                    ],
